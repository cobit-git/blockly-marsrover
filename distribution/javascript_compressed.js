...
var module$contents$Blockly$JavaScript$mars_rover_sleep=function(a){for(a=Date.now()+a;Date.now()<a;);},module$exports$Blockly$JavaScript={},module$contents$Blockly$JavaScript_Variables=$.module$build$src$core$variables,module$contents$Blockly$JavaScript_stringUtils=$.module$build$src$core$utils$string,module$contents$Blockly$JavaScript_CodeGenerator=$.CodeGenerator$$module$build$src$core$generator,module$contents$Blockly$JavaScript_inputTypes=$.module$build$src$core$input_types.inputTypes,module$contents$Blockly$JavaScript_Names=
$.module$build$src$core$names.Names,module$contents$Blockly$JavaScript_NameType=$.NameType$$module$build$src$core$names;module$exports$Blockly$JavaScript.javascriptGenerator=new $.CodeGenerator$$module$build$src$core$generator("JavaScript");
...
`)+"("+b+", "+c+", "+a+")",module$exports$Blockly$JavaScript.javascriptGenerator.ORDER_FUNCTION_CALL]};var module$exports$Blockly$JavaScript$mars_rover={};module$exports$Blockly$JavaScript.javascriptGenerator.move_forward=function(a){return"move_forward_acorn();\nwaitForSeconds(0.3);\n"};module$exports$Blockly$JavaScript.javascriptGenerator.move_backward=function(a){return"move_backward_acorn();\nwaitForSeconds(0.3);\n"};module$exports$Blockly$JavaScript.javascriptGenerator.rover_stop=function(a){return"rover_stop_acorn();\nwaitForSeconds(0.3);\n"};
module$exports$Blockly$JavaScript.javascriptGenerator.object_detect=function(a){return"object_detect_acorn();\n"};module$exports$Blockly$JavaScript.javascriptGenerator.wait_seconds=function(a){return"waitForSeconds("+Number(a.getFieldValue("SECONDS"))+");\n"};module$exports$Blockly$JavaScript.javascriptGenerator.turn_left=function(a){return"turn_left_acorn();\nwaitForSeconds(0.3);\n"};module$exports$Blockly$JavaScript.javascriptGenerator.turn_right=function(a){return"turn_right_acorn();waitForSeconds(0.3);\n\n"};
module$exports$Blockly$JavaScript.javascriptGenerator.led_on=function(a){return"led_on_acorn();\nwaitForSeconds(0.3);\n"};module$exports$Blockly$JavaScript.javascriptGenerator.led_off=function(a){return"led_off_acorn();\nwaitForSeconds(0.3);\n"};module$exports$Blockly$JavaScript.javascriptGenerator.console_print=function(a){return"console.log("+Blockly.JavaScript.valueToCode(a,"CONSOLE_LOG",Blockly.JavaScript.ORDER_ATOMIC)+")\n"};
module$exports$Blockly$JavaScript.javascriptGenerator.read_angle=function(a){return["read_angle_acorn()",Blockly.JavaScript.ORDER_NONE]};module$exports$Blockly$JavaScript.javascriptGenerator.read_sensor1=function(a){return["read_front_sensor_acorn()",Blockly.JavaScript.ORDER_NONE]};module$exports$Blockly$JavaScript.javascriptGenerator.read_sensor2=function(a){return["read_rear_sensor_acorn()",Blockly.JavaScript.ORDER_NONE]};setTimeout(function(){console.log("Works!")},3E3);var module$exports$Blockly$JavaScript$lists={},module$contents$Blockly$JavaScript$lists_NameType=$.NameType$$module$build$src$core$names;module$exports$Blockly$JavaScript.javascriptGenerator.lists_create_empty=function(a){return["[]",module$exports$Blockly$JavaScript.javascriptGenerator.ORDER_ATOMIC]};
