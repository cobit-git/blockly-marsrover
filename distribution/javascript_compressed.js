...
`)+"("+b+", "+c+", "+a+")",module$exports$Blockly$JavaScript.javascriptGenerator.ORDER_FUNCTION_CALL]};var module$exports$Blockly$JavaScript$mars_rover={};module$exports$Blockly$JavaScript.javascriptGenerator.move_forward=function(a){return"motor_speed = "+a.getFieldValue("SPEED")+";\n document.dispatchEvent(event_move_forward);\n "};module$exports$Blockly$JavaScript.javascriptGenerator.rover_stop=function(a){return"document.dispatchEvent(event_rover_stop);\n"};module$exports$Blockly$JavaScript.javascriptGenerator.wait_mili_sec=function(a){return"wait_time = "+a.getFieldValue("MILI_SEC")+";\n wakeUpTime = Date.now() + wait_time;\n while (Date.now() < wakeUpTime) {};\n"};
module$exports$Blockly$JavaScript.javascriptGenerator.led_on=function(a){return'console.log("LED on");\n document.dispatchEvent(event_led_on);\n'};module$exports$Blockly$JavaScript.javascriptGenerator.led_off=function(a){return'console.log("LED off");\n document.dispatchEvent(event_led_off);\n'};module$exports$Blockly$JavaScript.javascriptGenerator.console_print=function(a){return"console.log("+Blockly.JavaScript.valueToCode(a,"CONSOLE_LOG",Blockly.JavaScript.ORDER_ATOMIC)+")\n"};
setTimeout(function(){console.log("Works!")},3E3);var module$exports$Blockly$JavaScript$lists={},module$contents$Blockly$JavaScript$lists_NameType=$.NameType$$module$build$src$core$names;module$exports$Blockly$JavaScript.javascriptGenerator.lists_create_empty=function(a){return["[]",module$exports$Blockly$JavaScript.javascriptGenerator.ORDER_ATOMIC]};
